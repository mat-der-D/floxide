...
- [ ] 3. `PrimitiveMesh` 基本実装（primitive_mesh.rs）
...
- [ ] 4.1 (P) 面重心・面積ベクトル計算関数の実装（geometry.rs）
...
- [ ] 4.2 (P) 面ジオメトリ遅延計算アクセサの実装（primitive_mesh.rs）
...
- [ ] 5.1 (P) セル体積・重心計算関数の実装（geometry.rs）
...
- [ ] 5.2 (P) セルジオメトリ遅延計算アクセサの実装（primitive_mesh.rs）
...
- [ ] 6.1 (P) cell_faces・cell_cells・cell_points 計算関数の実装（geometry.rs）
...
- [ ] 6.2 (P) 接続情報遅延計算アクセサの実装（primitive_mesh.rs）
